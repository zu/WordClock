...
// Given a Date, returns the set of LED indices to render:
// `on` (full brightness, the words) and `dim` (the four minute dots).
function getLedsForTime(date) {
    let timerepr = [];
    let dotrepr = [];
